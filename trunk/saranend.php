...
<div id="editorial_block_center" class="editorial_block">  		 
	...
	<div><p style="text-align: center;">&nbsp;</p>
      Pesan  Anda <b>SUDAH TERKIRIM !</b>      . <br />
<br />
Terima Kasih Atas Saran yang sudah Anda Berikan.
...
mysql_select_db("dbtgs",$knek);
	$dbmask = "INSERT INTO saran VALUES ('','$_POST[TF1]','$_POST[TF2]','$_POST[TF3]','$_POST[TF4]')";
