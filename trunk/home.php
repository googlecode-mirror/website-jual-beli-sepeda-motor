...
-->
	...
	<body id="index">
			...
			<div>
				<h1 id="logo">&nbsp;</h1>
				<div id="header">
				  <table width="239" height="95" border="0" align="right" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" bgcolor="#CCCCCC">
                    <form action="login.php" method="post" name="login">
                      <tr>
                        <td width="32%" height="21" class="body_txt">Username</td>
                        <td colspan="2"><input name="username" type="text" id="username" size="16" /></td>
                      </tr>
                      <tr>
                        <td height="24" class="body_txt">Password</td>
                        <td colspan="2"><input name="password" type="password" id="password" size="16" /></td>
                      </tr>
                      <tr>
                        <td height="24">&nbsp;</td>
                        <td width="21%"><input name="login" type="submit" id="login" value=" Login "></td>
                        <td><p class="body_txt">&nbsp;</p></td>
                      </tr>
                    </form>
			      </table>
